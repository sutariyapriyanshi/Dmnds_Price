...
For Better understanding refers [American Gem Society](https://www.americangemsociety.org/4cs-of-diamonds/).
...
Here we have used 3 different Algorithms for the **price** columns which is as below.
